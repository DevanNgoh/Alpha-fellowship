        ...
        <div class="person">
            <div class="person-header">
                ...
                <div class="person-info">
                    ...
                    <div class="person-church">⛪ ${escapeHtml(displayChurch)}</div>
                    <div class="person-country">🌍 ${escapeHtml(displayCountry)}</div>
                </div>
                <button onclick="deleteEntry('${rawName.replace(/\\/g, "\\\\").replace(/'/g, "\\'")}', '${person.date}')" class="delete-btn" title="Delete entry">
...
// Modal DOM Hooks & Open/Close Handlers
...
if (closeModalX) closeModalX.addEventListener("click", () => addPastorModal.style.display = "none");

// Close Modal when clicking outside the box
window.addEventListener("click", (e) => {
    if (e.target === addPastorModal) {
...
if (clearLogBtn) {
    clearLogBtn.addEventListener("click", () => {
        if (!activityLog) return;
        const isHidden = activityLog.style.display === "none";
        activityLog.style.display = isHidden ? "block" : "none";
        clearLogBtn.classList.toggle("log-hidden", !isHidden);
        clearLogBtn.innerHTML = isHidden
            ? '<i class="fa-solid fa-eye-slash"></i> Clear Log'
            : '<i class="fa-solid fa-eye"></i> Show Log';
    });
}
